...
begin
    ...
    insert into auth_users (email, password_hash, password_confirmed) values ('user@badpassword', sys.hash('password'), true);
    ...
    values ('user@goodpassword', sys.hash('password'), true);

...
begin
    ...
    insert into auth_users (email, password_hash, confirmed) values ('user@badpassword', sys.hash_to_array('password'), true);
    ...
    insert into auth_users (email, password_hash, confirmed) 
    values ('user@goodpassword', sys.hash_to_array('password'), true);
